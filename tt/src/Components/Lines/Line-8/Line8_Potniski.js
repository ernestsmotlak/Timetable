...
const Line8_Potniski = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('http://84.247.184.37:3001/Linija8/PotniskiTerminal');
    ...
    return (
        <div>
            ...
            <div className='line1-kampel mt-3 mb-4'>
                <h1 className="d-flex justify-content-center display-1">Linija 8</h1>
                ...
                {isMobile ? (<div className="col-md-6">
                    ...
                    <div className="row w-75 l1" style={{ marginTop: '0px' }}>
                        ...
                        <div className="col l1" style={{ marginTop: '4%', color: 'rgb(149, 136, 112)', fontWeight: '400' }}>
                    ...
                    <div className="row">
                        <div className="col text-truncate">
                            <select className="form-select" aria-label="Default select example" onChange={(event) => { handleVhod(event); print_Vhod(event); }}>
                                ...
                                <option value='Ulica_15._Maja'>Ulica 15. Maja</option>
                                <option value='Rozmanova_ulica_I'>Rozmanova ulica I</option>
                                <option value='Prisoje'>Prisoje</option>
                                <option value='Prisoje_pod_garažo'>Prisoje pod garažo</option>
                                <option value='Oljčna_pot-Lantana'>Oljčna pot-Lantana</option>
                                <option value='Dolinska_cesta'>Dolinska cesta</option>

          ...
          <div className="row d-flex justify-content-center">
            ...
            <div className="col-md-6">
              <div className="row" style={{ marginLeft: '25%' }}>
                ...
                <div className="col-md-12">
                  <div className="mb-3">
                    <h1 className="display-4 bi bi-arrow-down l1" style={{ marginLeft: '23%', fontWeight: '400', color: '#958870' }}></h1>
                  </div>
                </div>
                <div className="col-md-12">
                  <div className="mb-3 display-6" style={{ marginLeft: '7%', fontWeight: '400', color: '#958870' }}>
                ...
                <div className="col-md-12" style={{ marginTop: '5%' }}>
                  <div className="mb-3" style={{ marginLeft: '22%' }}>
        ...
        <div className='outer'>
          <div className="container text-center d-flex justify-content-center l1" style={{ marginLeft: '2.5%' }}>
            <div className="row w-100 mt-3 l1 ">
              <div className="col display-4 l1" style={{marginTop: "35px"}}>
                PH Sonce
              </div>
              ...
              <div className="col align-self-center l1" style={{marginTop: "20px"}}>
                <button type="button" className="btn custom-btn" onClick={goToKoper}>
                  <i className="bi bi-bus-front-fill"></i>
                </button>
              </div>

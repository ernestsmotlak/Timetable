...
const Line_6 = () => {
    ...
    const goToPotniskiTerminal = () => {
        navigate('/Linija6/PotniskiTerminal');
    }

    const goToMarkovecCenter = () => {
        navigate('/Linija6/Markovec');
    }
                    ...
                    <div className="container l3 custom">
                        <div className="row">
                            ...
                            <div className="col-md-6 l3">
                                <div className="row display-6" style={{ color: '#958870', fontWeight: '400' }}>
                                    <div className="col-md-12">
                                        <div className="mb-3">Potniški terminal</div>
                                    </div>
                                    ...
                                    <div className="col-md-12">
                                        <div className="mb-3 l3">
                                            <button type="button" className="btn custom-btn" onClick={goToMarkovecCenter} style={{ marginTop: '2%' }}>
                            ...
                            <div className="col-md-6 l3">
                                <div className="row display-6" style={{ color: '#958870', fontWeight: '400' }}>
                                    <div className="col-md-12">
                                        <div className="mb-3 l3 top-right">Markovec Center Za Gradom</div>
                                    </div>
                                    ...
                                    <div className="col-md-12 l3 second-button">
                                        <div className="mb-3 l3">
                                            <button type="button" className="btn custom-btn" onClick={goToPotniskiTerminal} style={{marginLeft: '5px'}}>
                                                <i className="bi bi-bus-front-fill"></i>
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div className="container text-center d-flex justify-content-center l1 l3">
                        <div className="row w-100 l1">
                            ...
                            <div className="col align-self-center l1">
                                <button type="button" className="btn custom-btn" onClick={goToPotniskiTerminal}>
                                    <i className="bi bi-bus-front-fill"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="container text-center d-flex justify-content-center lower l1 l3">
                        <div className="row w-100 l1">
                            ...
                            <div className="col align-self-center" style={{ marginBottom: '10px' }}>
                                <button type="button" className="btn custom-btn" onClick={goToMarkovecCenter}>
                                    <i className="bi bi-bus-front-fill"></i>
                                </button>
                            </div>
                        </div>

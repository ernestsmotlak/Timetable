...
const Line6_Potniski = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('http://84.247.184.37:3001/Linija6/PotniskiTerminal');
  ...
  return (
    <div>
      ...
      {isMobile ? (<div className='line1-kampel mt-3 mb-4 l3'>
        <h1 className="d-flex justify-content-center display-1">Linija 6</h1>

        <div className="col-md-6 l3-bolnisnica">
          <div className="row">
            <div className="col-md-12">
              <div className="mb-3 display-6 l3-bolnisnica">Markovec Center <br /> Za Gradom</div>
            </div>
            <div className="col-md-12">
            ...
            <div className="col-md-12">
              <div className="mb-3 display-6 l3-bolnisnica">Potniski terminal</div>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col text-truncate">
              <select className="form-select" aria-label="Default select example" onChange={(event) => { handleVhod(event); print_Vhod(event); }}>
                ...
                <option value='Markovec-Center_Za_gradom1'>Markovec Center Za Gradom</option>
                ...
                <option value='II._Prekomorske'>II. Prekomorske</option>
                <option value='Kraljeva'>Kraljeva</option>
                <option value='Kraljeva_K'>Kraljeva K</option>
                <option value='Markovec-Center_Za_gradom'>Markovec Center Za Gradom</option>
                <option value='Kozlovičeva'>Kozlovičeva</option>
                <option value='Žusterna_III'>Žusterna III</option>
                <option value='Izletniška_pot'>Izletniška pot</option>
                <option value='Krožna'>Krožna</option>
                <option value='Krožna_K'>Krožna K</option>
                <option value='Molet'>Molet</option>
                <option value='Žusterna-bazen'>Žusterna bazen</option>
        ...
        <div className="container text-center d-flex justify-content-center">
          <div className="row custom">
            <div className="col display-5 l3" style={{ marginTop: '0%', marginBottom: '3%', whiteSpace: 'nowrap', fontWeight: '400' }}>Markovec Center <br /> Za Gradom</div>
            <div className="col">
              <h1 className="display-4 bi bi-arrow-right" style={{ marginTop: '28%' }}></h1>
            </div>
            <div className="col display-5" style={{fontWeight: '400'}}>Potniški <br /> terminal</div>
          </div>
        </div>

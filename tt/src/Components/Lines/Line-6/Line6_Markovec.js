...
const Line6_Markovec = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('http://84.247.184.37:3001/Linija6/Markovec');
        ...
        <div>
            ...
            {isMobile ? (<div className='line1-kampel mt-3 mb-4 l3'>
                ...
                <div class="col-md-6 l3-bolnisnica">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3 display-6 l3-bolnisnica">Potniski terminal</div>
                        </div>
                        <div class="col-md-12">
                    ...
                    <div className="row">
                        <div className="col text-truncate">
                            <select className="form-select" aria-label="Default select example" onChange={(event) => { handleVhod(event); print_Vhod(event); }}>
                                ...
                                <option value='Dolga_Reber'>Dolga Reber</option>
                                <option value='Žusterna_III'>Žusterna III</option>
                                <option value='Beblerjeva_K'>Beblerjeva K</option>
                ...
                <div className="container text-center d-flex justify-content-center">
                    <div className="row custom">
                        <div className="col display-4 l3" style={{ marginTop: '4.5%' }}>Potniški <br /> terminal</div>
                        <div className="col">
                            <h1 className="display-4 bi bi-arrow-right" style={{ marginTop: '28%' }}></h1>
                        </div>
                        <div className="col display-4">Markovec Center Za Gradom</div>
                    </div>
                </div>

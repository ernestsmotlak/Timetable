...
const Line11_Banka = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('http://84.247.184.37:3001/Linija11/Banka');
    ...
    return (
        <div>
            ...
            <div className='line1-kampel mt-3 mb-4'>
                ...
                {isMobile ? (<span style={{ marginLeft: '27.5%', color: '#b4ab9a' }}>via Potniški terminal</span>) : (<span style={{ marginLeft: '39%', color: '#b4ab9a', fontSize: '1.5rem' }}>via Potniški terminal</span>)}
                ...
                {isMobile ? (<div className="col-md-6">
                    ...
                    <div className="row w-75 l1" style={{ marginTop: '0px' }}>
                        ...
                        <div className="col l1" style={{ marginTop: '5%' }}>
                ...
                {isMobile ? (<div></div>) : (<span className='description' style={{ marginLeft: '32.5%', color: '#b4ab9a' }}>Cimos P&R <i className='bi bi-arrow-right'></i> Potniški terminal <i className='bi bi-arrow-right'></i> Cimos P&R </span>)}
                    ...
                    <div className="row">
                        <div className="col text-truncate">
                            <select className="form-select" aria-label="Default select example" onChange={(event) => { handleVhod(event); print_Vhod(event); }}>
                                ...
                                <option value='Cimos_P&R1'>Cimos P&R</option>

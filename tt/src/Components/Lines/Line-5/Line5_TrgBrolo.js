...
const Line5_Markovec = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('http://84.247.184.37:3001/Linija5/TrgBrolo');
    ...
    return (
        <div>
            ...
            {isMobile ? (<div className='line1-kampel mt-3 mb-4 l3'>
                ...
                <div class="col-md-6 l3-bolnisnica">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3 display-6 l3-bolnisnica">Markovec Center <br /> Za Gradom</div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3 display-6 l3-bolnisnica">Trg Brolo</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container text-center d-flex justify-content-center">
                    <div className="row custom">
                        <div className="col display-4 l3">Markovec Center <br /> Za Gradom</div>
                        <div className="col">
                            <h1 className="display-4 bi bi-arrow-right" style={{ marginTop: '28%' }}></h1>
                        </div>
                        <div className="col display-4">Trg Brolo</div>
                    </div>
                </div>

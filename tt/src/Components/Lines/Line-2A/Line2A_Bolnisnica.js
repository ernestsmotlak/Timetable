...
const Line2A_Bolnisnica = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('http://84.247.184.37:3001/Linija2A/Bolnisnica');
    ...
    return (
        <div>
            ...
            {isMobile ? (<div className='line1-kampel mt-3 mb-4 l3'>
                    ...
                    <div className="row">
                        <div className="col text-truncate">
                            <select className="form-select" aria-label="Default select example" onChange={(event) => { handleVhod(event); print_Vhod(event); }}>
                                ...
                                <option value='Vena_Pilona'>Vena Pilona</option>
                ...
                <div className="container text-center d-flex justify-content-center" style={{marginLeft: '-20px'}}>
                    <div className="row custom">
                        <div className="col display-4 l3">Koper</div>
                        <div className="col">
...
export default Line2A_Bolnisnica;
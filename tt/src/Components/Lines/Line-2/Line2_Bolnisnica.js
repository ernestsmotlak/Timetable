...
const Line2_Bolnisnica = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('http://84.247.184.37:3001/Linija2/Bolnisnica');
      ...
      <div className='line1-kampel mt-3 mb-4'>
        ...
        <div className="container text-center d-flex justify-content-center">
          <div className="row custom">
            <div className="col display-4 l2">Koper</div>
            <div className="col l2">
              <h1 className="display-4 bi bi-arrow-right"></h1>
            </div>
            <div className="col display-4 l2 lower">Bolnišnica</div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col text-truncate">
              <select className="form-select" aria-label="Default select example" onChange={(event) => { handleVhod(event); print_Vhod(event); }}>
                ...
                <option value='Supernova'>Koper</option>
...
export default Line2_Bolnisnica;
...
const Line10_Srmin = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('http://84.247.184.37:3001/Linija10/Srmin');
                    ...
                    <div className="row">
                        <div className="col text-truncate">
                            <select className="form-select" aria-label="Default select example" onChange={(event) => { handleVhod(event); print_Vhod(event); }}>
                                ...
                                <option value='Srmin_GORC_I1'>Srmin GORC I</option>
                                <option value='Srmin_GORC_II1'>Srmin GORC II</option>
                                <option value='Srmin_GORC_III1'>Srmin GORC III</option>
                                <option value='Supernova'>Supernova</option>
                                <option value='Čebelnjak1'>Čebelnjak</option>
                                ...
                                <option value='Barka_I.'>Barka I</option>
                                <option value='Čebelnjak'>Čebelnjak</option>
                                <option value='Srmin_GORC_I'>Srmin GORC I</option>
                                <option value='Srmin_GORC_II'>Srmin GORC II</option>
                                <option value='Srmin_GORC_III'>Srmin GORC III</option>
                            </select>

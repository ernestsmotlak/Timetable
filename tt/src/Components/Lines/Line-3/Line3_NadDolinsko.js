...
const Line3_NadDolinsko = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('http://84.247.184.37:3001/Linija3/nadDolinsko');
          ...
          <div className="row">
            <div className="col text-truncate">
              <select className="form-select" aria-label="Default select example" onChange={(event) => { handleVhod(event); print_Vhod(event); }}>
                ...
                <option value='Rozmanova_I'>Rozmanova I</option>
                <option value='Prisoje'>Prisoje</option>
                <option value='Prisoje_pod_gar'>Prisoje pod gar</option>
                <option value='Oljčna_pot_Lantana'>Oljčna pot Lantana</option>
                <option value='Dolinskam'>Dolinska</option>
...
export default Line3_NadDolinsko;
...
const Line3_Bolnisnica = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('http://84.247.184.37:3001/Linija3/Bolnisnica');
      ...
      {isMobile ? (<div className='line1-kampel mt-3 mb-4 l3'>
        ...
        <div className="col-md-6 l3-bolnisnica">
          <div className="row">
            <div className="col-md-12">
              <div className="mb-3 display-6 l3-bolnisnica">Nad Dolinsko</div>
            </div>
            <div className="col-md-12">
          ...
          <div className="row">
            <div className="col text-truncate">
              <select className="form-select" aria-label="Default select example" onChange={(event) => { handleVhod(event); print_Vhod(event); }}>
                ...
                <option value='Nad_Dolinsko'>Nad Dolinsko</option>
                <option value='Mercator'>Mercator</option>
                <option value='Dolinska'>Dolinska</option>
                <option value='Oljčna_pot_Lantana'>Oljčna pot Lantana</option>
                <option value='Olmo_Eden'>Olmo Eden</option>
                <option value='Tomšičeva_K'>Tomšičeva_K</option>
                <option value='Tomšičeva'>Tomšičeva</option>
                <option value='Rozmanova_Š'>Rozmanova_Š</option>
                <option value='Vena_Pilona'>Vena_Pilona</option>
                <option value='Markovec_Š'>Markovec_Š</option>
        ...
        <div className="container text-center d-flex justify-content-center">
          <div className="row custom">
            <div className="col display-4 l3">Nad Dolinsko</div>
            <div className="col">
              <h1 className="display-4 bi bi-arrow-right"></h1>
            </div>
            <div className="col display-4">Bolnišnica</div>
          </div>
        </div>
...
export default Line3_Bolnisnica;